*"* use this source file for your ABAP unit test classes
    ...
    CLASS ltcl_integration_test IMPLEMENTATION.
     ...
     METHOD create_travel.
      ...
      DATA travels_in TYPE TABLE FOR CREATE zmd_i_travel_u\\travel.
      ...
      MODIFY ENTITIES OF zmd_i_travel_u
        ENTITY travel
      ...
      SELECT * FROM  zmd_i_travel_u WHERE TravelId = @new_travel_id INTO TABLE @DATA(lt_travel)  .
    ...
    METHOD class_setup.
      cds_test_environment = cl_cds_test_environment=>create_for_multiple_cds(
          i_for_entities = VALUE #( ( i_for_entity = 'zmd_i_travel_u' )
                                  ( i_for_entity = 'zmd_i_booking_u' ) )
                                ).
    ENDMETHOD.
